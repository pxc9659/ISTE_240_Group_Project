<nav id="navDiv" class="sideNav">
	...
	<ul>
		<li<?php if(isset($nav) && $nav=='system_introduction'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/system_introduction.php">Introduction</a></li>
		<li<?php if(isset($nav) && $nav=='top'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/top.php">top</a></li>
		<li<?php if(isset($nav) && $nav=='w'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/w.php">w</a></li>
		<li<?php if(isset($nav) && $nav=='du'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/du.php">du</a></li>
		<li<?php if(isset($nav) && $nav=='ping'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/ping.php">ping</a></li>
		<li<?php if(isset($nav) && $nav=='df'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/df.php">df</a></li>
		<li<?php if(isset($nav) && $nav=='ifconfig'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/ifconfig.php">ifconfig</a></li>
		<li<?php if(isset($nav) && $nav=='free'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/free.php">free</a></li>
		<li<?php if(isset($nav) && $nav=='system_quiz'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/SystemInformation/system_quiz.php">Quiz</a></li>
	</ul>

	<input type="checkbox" name="netservices" id="netservices">
	<label for="netservices">Network Services</label>
	<ul>
		<li<?php if(isset($nav) && $nav=='netservices_introduction'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/netservices_introduction.php">Introduction</a></li>
		<li<?php if(isset($nav) && $nav=='scp'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/scp.php">scp</a></li>
		<li<?php if(isset($nav) && $nav=='ssh'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/ssh.php">ssh</a></li>
		<li<?php if(isset($nav) && $nav=='wget'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/wget.php">wget</a></li>
		<li<?php if(isset($nav) && $nav=='ftp'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/ftp.php">ftp</a></li>
		<li<?php if(isset($nav) && $nav=='netstat'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/netstat.php">netstat</a></li>
		<li<?php if(isset($nav) && $nav=='iptables'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/iptables.php">iptables</a></li>
		<li<?php if(isset($nav) && $nav=='nfs'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/nfs.php">nfs</a></li>
		<li<?php if(isset($nav) && $nav=='samba'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/samba.php">samba</a></li>
		<li<?php if(isset($nav) && $nav=='netservices_quiz'){echo ' class="active" style="background: #4f4e4e"';}?>><a href="<?php echo $path;?>pages/netservices/netservices_quiz.php">Quiz</a></li>
	</ul>
